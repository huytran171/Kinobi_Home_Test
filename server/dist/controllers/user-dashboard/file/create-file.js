...
function makeCreateFileController(_a) {
    var createFile = _a.createFile;
    return function createFileController(req) {
        return __awaiter(this, void 0, void 0, function () {
            var headers, file, invalid_data, payload, created, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        file = req.file;
                        invalid_data = !file || Object.keys(file).length === 0;
                        if (invalid_data) {
                        ...
                        return [4, createFile({ payload: payload })];
                    case 2:
                        created = _a.sent();
                        return [2, {
                                headers: headers,
